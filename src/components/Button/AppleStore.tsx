...
const AppleStore = ({ className, mode = "dark" }: Props) => {
  ...
  const iconClasses = clsx("transition-all", {
    "dark:fill-light-utility-high fill-dark-utility-high group-hover:fill-light-source-white group-hover:dark:fill-dark-source-white": mode === 'dark',
    "fill-light-source-white dark:fill-dark-source-white": mode === 'transparent'
  })
